...
```
## Single coverage Application


```{r shiny2, echo=FALSE, cache = FALSE, message = FALSE}
...
single_coverage_plot(input = cvg_mats[[1]],#bam_files, 
                    regions = tss_in_peaks, 
                    region_names = tss_in_peaks$names, 
                    cvg_files = cvg_files)
...
## Single coverage Application with fewer tracks
