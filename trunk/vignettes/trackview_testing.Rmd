...
track_info <- chipVis::plot_track_view(cvg.L = cvg, target.range=range.gene, sync = TRUE, genome=genome, transcripts.gr = full.exon, showSNPs = TRUE, snp.gr = snps, tss.gr = tss_db)
```