...
multi_coverage_heatmap(MCF7_PR_tss_cvg_mats, row_order = "kmeans", y = tss_in_peaks$names, k = 3)
```
...
```{r}
ag1 = aggregate_profile_plot(er_progesterone_peaks_cvg_mats[1:3],xlab = "Position relative to ER Peaks<br> in T47D + Progesterone",
                            ylab = "ER ChIP-Signal")
ag2 = aggregate_profile_plot(er_progesterone_peaks_cvg_mats[4:6],ylab = "Position relative to ER Peaks<br> in T47D + Progesterone",
                            ylab = "PR ChIP-Signal")

ag1 %>% export(file = "/gne/research/workspace/schepa/Carroll_Data/Figures/aggregate_profiles1.pdf")
